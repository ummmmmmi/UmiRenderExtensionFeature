...
//            _GPU_Animation_Structured_Tint           ("GPU动画融合度", Range(0, 1))            = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.umi-render-extension-feature/EndField/Shader/CBT-2/Character/EndFieldToonFunc/EndFieldToonHairFunc.hlsl"
            #include "Packages/com.unity.umi-render-extension-feature/EndField/Shader/CBT-2/Character/Helper/GPU_Animation_Function.hlsl"
            ...
            //region combine lighting
                ...
                float3 resultColor = finalColor / _ExposureParams.xxx;  //可能是反曝光
                float4 outputColor;
