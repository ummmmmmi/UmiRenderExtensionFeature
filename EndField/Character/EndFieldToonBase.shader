    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // 7. 间接光与高光计算 (Indirect & Specular)
                ...
                float3 finalIndirectSpec = lerp(indSpecStep2, indSpecStep1 * _CharacterParams0.y, shadowData.scene);    //可能改名为EnvDiffuse
                ...
                float3 lightingColor = finalIndirectSpec * (directDiffuse + directSpecular);
                ...
                float3 rimFinalColor = ApplyManualRimFeature(diffuseSat, vecData, shadowData, surface);
